...
# Start the demo app
java -classpath target/amazon-kinesis-video-streams-producer-sdk-java-1.10.0.jar:$classpath_values -Daws.accessKeyId=${ACCESS_KEY} -Daws.secretKey=${SECRET_KEY} -Djava.library.path=/opt/amazon-kinesis-video-streams-producer-sdk-cpp/build/ com.amazonaws.kinesisvideo.demoapp.DemoAppMain
